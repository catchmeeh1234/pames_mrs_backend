<?php 
    ...
    class Connect {
        //private $dsn = "sqlsrv:Server=localhost;Database=PAMES;TrustServerCertificate=true";
        private $dsn = "sqlsrv:Server=192.168.10.17;Database=PAMES;TrustServerCertificate=true";
        ...
        public function connectionStatus($conn) {
